        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#" className="text-[#5C5C5C] hover:text-[#D4AF37] transition-colors">
                  Home
                </a>
              </li>
              <li>
                <a href="#estimate" className="text-[#5C5C5C] hover:text-[#D4AF37] transition-colors">
                  Get Estimate
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center space-x-2">
                ...
                <a href="tel:2538451234" className="text-[#5C5C5C] hover:text-[#D4AF37] transition-colors">
                  (253) 845-1234
                </a>
              </li>
              <li className="flex items-center space-x-2">
                ...
                <a
                  ...
                  className="text-[#5C5C5C] hover:text-[#D4AF37] transition-colors"
                >
              ...
              <li className="flex items-start space-x-2">
                ...
                <span className="text-[#5C5C5C]">Serving Puyallup & Pierce County, WA</span>
              </li>
            </ul>
          </div>
        </div>

        <div className="border-t border-gray-800 pt-8 text-center text-sm text-[#5C5C5C]">
